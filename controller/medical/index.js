...
router
    ...
    .get(JWT.verifyAccessToken, (req, res) => {
        try {
            const sql = "SELECT * FROM user_medical";
    ...
    .post(JWT.verifyAccessToken, async (req, res) => {
        ...
        const sql = `INSERT INTO user_medical (id, user_id) 
    values (?, ?)`;
        try {
...
router
    ...
    .delete(JWT.verifyAccessToken, (req, res) => {
        const id = req.query.id;
        try {
            const sql = 'DELETE FROM user_medical WHERE id = ?';
...
router.get("/:id", JWT.verifyAccessToken, (req, res) => {
    ...
    try {
        sql = "SELECT * FROM user_medical WHERE user_id = ?";
