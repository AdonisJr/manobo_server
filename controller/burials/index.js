...
router
    ...
    .get(JWT.verifyAccessToken, (req, res) => {
        ...
        try {
            const sql = "SELECT * FROM burial WHERE user_id = ? ORDER BY created_at DESC";
    ...
    .post(upload.array('files', 4), checkMedical, checkBurial, checkSchoolarship, checkCertification, checkRecommendation, async (req, res) => {
        const user_id = req.body.id;
        console.log(user_id)
